-- Drop the existing trigger and function for recurring tasks
DROP TRIGGER IF EXISTS on_recurring_task_completed ON public.tasks;
DROP FUNCTION IF EXISTS public.create_recurring_task_instance();
