...
export const ProjectTable = ({
  ...
  }) => <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition-colors" onClick={() => handleSort(field)}>
        ...
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            ...
            return <React.Fragment key={project.id}>
                  <tr className="hover:bg-gray-50 transition-colors cursor-pointer" onClick={e => {
                ...
                handleRowClick(project);
                    ...
                    <td className="px-4 py-4">
                      <div className="space-y-2">
                        ...
                        <div className="text-xs text-gray-500">
                          ...
                          {stats.overdueTasks > 0 && <span className="text-red-600 ml-1">({stats.overdueTasks} overdue)</span>}
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="px-4 py-4">
                      <div className="flex space-x-1">
                        <Button size="sm" variant="ghost" className="p-1 h-6 w-6 hover:bg-blue-100" onClick={e => handleActionClick(e, () => onCreateTask(project.id))} title="Create New Task">
                          <Plus className="w-3 h-3 text-blue-600" />
                        </Button>
                        
                        {onGenerateReport && <Button size="sm" variant="ghost" className="p-1 h-6 w-6 hover:bg-purple-100" onClick={e => handleActionClick(e, () => onGenerateReport(project))} title="Generate Report">
                        ...
                        <Card>
                          <CardContent className="p-4">
                            ...
                            {stats.projectTasks.length > 0 ? <div className="space-y-2">
                                {stats.projectTasks.map(task => <div key={task.id} className="flex items-center justify-between p-2 bg-white rounded border">
                              ...
                              </div> : <p className="text-sm text-gray-500">No tasks assigned to this project yet.</p>}
                          </CardContent>
                        </Card>
                      </td>
                    </tr>}
