...
export const MeetingSummaryCardsOptimized = React.memo(({ 
  tasks, 
  taskCounts,
  activeFilter, 
  onFilterChange,
  ...
  const handleFilterClick = (filter: FilterType) => {
    ...
    if (onSortChange && (filter === 'all' || filter === 'active')) {
      // Combined sorting: Due Date (older to newer) + Priority (Critical, High, Medium, Low)
      onSortChange('dueDatePriority', 'asc');
    }
  };
...
MeetingSummaryCardsOptimized.displayName = 'MeetingSummaryCardsOptimized';
